...
func TestRawRoundTrip(t *testing.T) {
	enc, _ := NewRSARawEncryptorBuilder().Build()
...
func TestRawRoundTripCustomKey(t *testing.T) {
	...
	enc, _ := NewRSARawEncryptorBuilder().PrivateKey(key).Build()
	encrypted, err := enc.Encrypt("test")
	if err != nil {
		t.Errorf("Decrypt(%v) = %v; want %v", encrypted, err, "test")
	}
...
func TestRawDecryptWithoutPrivateKey(t *testing.T) {
	...
	key, _ := ParsePublicKey([]byte(exampleRSA4096Key))
	dec, _ := NewRSARawEncryptorBuilder().PublicKey(key).Build()
...
func TestRawDecryptSpringCompatible(t *testing.T) {
	springCipherText := ""
	exampleRSA4096Key := "-----BEGIN RSA PRIVATE KEY-----\\n-----END RSA PRIVATE KEY-----\n"
	...
	dec, _ := NewRSARawEncryptorBuilder().PrivateKey(key).Build()
